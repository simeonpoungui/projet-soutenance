                ...
                if (a || s) {
                    ...
                    if (a)
                        if (i.globals.isBarHorizontal) {
                            ...
                            o = n < 0 ? "-100% 0% 0% 0%" : "0% 0% -100% 0%";
                    if (a && i.config.chart.stacked && e !== i.globals.series.length - 1 && i.config.plotOptions.bar.radiusOnLastStackedBar)
                        return;
      ...
      , b = function() {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                C.roundedCornerBars(M, a)) : C.animatePathsGradually(n(n({}, X), {}, {
                    speed: g
                })),
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                for (var n = e.globals.legendFormatter, o = e.config.legend.inverseOrder, l = o ? a.length - 1 : 0; o ? l >= 0 : l <= a.length - 1; o ? l-- : l++) {
                    ...
                    P.innerHTML = Array.isArray(h) ? f.sanitizeDom(h.join(" ")) : f.sanitizeDom(h);
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                s.series.map((function(e, d) {
                    ...
                    c.i.push(d)) : console.warn("You have specified an unrecognized chart type. Available types for this property are line/area/column/bar/scatter/bubble"),
